    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#" class="active">Le Temple</a></li>
                <li><a href="#">Liste des Jedis</a></li>
                <li><a href="#">Devenir un Jedi</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<footer class="footer">
    <div class="container">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            <p class="quicklinks">Copyright WCS & Wilders <img src="https://wildcodeschool.fr/wp-content/uploads/2017/01/logo_orange_pastille.png"  alt="Brand" width="20"/> </p>
        </div>
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            <ul class="list-inline quicklinks">
                <li><a href="https://github.com/splyy/WCS-StarWars" target="_blank"><i class="fa fa-github" aria-hidden="true"></i></a></li>
            </ul>
        </div>
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            <p class="quicklinks">Exercice de Soutien - by Pierre & Alexis</p>
        </div>
    </div>
</footer>
